    ...
    <>
      ...
      <div className='bg-[#f9f9f9]  text-[30px] lg:text-[40px] pt-8 lg:pt-16 pb-12 lg:pb-24 text-center'>
        ...
        <div className='mx-4 lg:mx-[20%]'>
          <p className='text-[27.5px] text-center'>{t('home01p1')}</p>
          <p className='text-[27.5px] text-center'>{t('home01p2')}</p>
          <p className='text-[27.5px] text-center'>{t('home01p3')}</p>
          <p className='text-[27.5px] text-center'>{t('home01p4')}</p>
        </div>
      </div>
    </>
  )
